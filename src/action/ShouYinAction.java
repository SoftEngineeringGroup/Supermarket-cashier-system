...
import service.*;
import service.impl.*;
public class ShouYinAction extends ActionSupport {
	...
	public String execute() throws Exception {
       ...
       //System.out.println(ServletActionContext.getRequest().getAttribute("EmpDAO"));
		System.out.println(this.getEmp().getCounterId()+this.getEmp().getTradeId()+this.getEmp().getMemberId()+this.getEmp().getBuyDate()+this.getEmp().getGoodsId()+this.getEmp().getSaleQuantity());
		this.getEmp().setPrice(us1.findGoodsmemberprice(this.getEmp().getGoodsId()));
